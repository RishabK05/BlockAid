...
mongoose.connect('mongodb+srv://id:<password>@cluster0.caawk.mongodb.net/?retryWrites=true&w=majority',{ useNewUrlParser: true,  useUnifiedTopology: true  }, function(err,db){
    if (!err){
        console.log('Connected to /BlockAid!');
    } else{
...
var hospitals= [new Hospi({
	...
	password: 'pass',
	hospitalpublickey: '0xD1728a15611918A835E8482774Adb0D60bFfc6AD',
